...
<form action="actions/livro.php" method="post">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-6">
            <input class="form-control" value='<?php echo $_GET['descricao']?>' type="text" name="descricao"/>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-6">
            <input type="text" value='<?php echo $_GET['categoria']?>' class="form-control" name="categoria"/>
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-4">
            <input class="form-control" value='<?php echo $_GET['data_lancamento']?>' type="date" name="data_lancamento"/>
        </div>
    </div>
